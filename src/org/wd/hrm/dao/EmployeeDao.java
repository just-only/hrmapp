...
import static org.wd.hrm.util.common.HrmConstants.EMPLOYEETABLE;
...
import org.wd.hrm.dao.provider.EmployeeDynaSqlProvider;
...
public interface EmployeeDao {
	...
	@Results({
		...
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="org.wd.hrm.dao.DeptDao.selectById",
		fetchType=FetchType.EAGER)),
		@Result(column="JOB_ID",property="job",
			one=@One(select="org.wd.hrm.dao.JobDao.selectById",
		fetchType=FetchType.EAGER))
	})
